    ...
    def __init__(self):
        ...
        self.questions = {
            "Gaming": {
                ...
                "Which company created Pokemon":"Gamefreak",
                "Which game is Faker known from? ":"League of Legends",
            ...
            "IT-Related": { 
                ...
                "What is often called the 'social coding platform'":"GitHub",
                "What is the name for a computer virus which replicates itself and uses up all a computer's processing space?":"Worm",
                "What is the famous computer virus associated with the Philippines":"ILOVEYOU",
                "What is the most widely used programming language?":"JavaScript",
                "What does 'CPU' stand for?":"Central Proccesing Unit",
            },
            "Movies": {
